...
Cloner (ou ouvrir) ce projet et ouvrir un terminal dans le dossier `gnoteFX1.2` :
...
## 🌐 API (Backend) - API_Gnotes

L'API sert de backend pour la synchronisation et l'accès centralisé aux données.

### Commandes utiles

**Commande pour obtenir son token d'authentification :**
```bash
...
**Commande pour récupérer des informations :**
```bash
