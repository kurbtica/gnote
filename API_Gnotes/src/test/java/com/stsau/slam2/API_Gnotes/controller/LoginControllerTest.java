...
public class LoginControllerTest {
    ...
    void setUp() {
        ...
        AuthenticationManager fakeAuthManager = authentication -> {
            if ("test@test.com".equals(authentication.getPrincipal()) && "password".equals(authentication.getCredentials())) {
        ...
        UserRepository fakeUserRepo = new UserRepository() {
            @Override public Optional<User> findByEmail(String email) {
                if ("test@test.com".equals(email)) return Optional.of(fakeUser);
